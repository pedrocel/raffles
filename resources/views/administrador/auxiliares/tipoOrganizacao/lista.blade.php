            ...
            <div class="col-sm-12">
                    <div class="card card-primary">
                      <div class="card-header">
                            <h3 class="card-title">Lista de Tipos de Organização</h3>
                      </div>
                    </div>
                  ...
                  <div class="card">  
                    <div class="card-body">
                      <table class="table table-bordered">
                        ...
                        <tbody>
                        @foreach($tipoOrganizacoes as $organizacao)
                          <tr>
                            <td><center>{{$organizacao->tipo_organizacao}}</center></td>
                        ...
                        {{$tipoOrganizacoes->appends(request()->all())->render()}}
                        </div>
                      </div>                 
                    </div>
                  </div>
