                                        ...
                                        <div class="col-sm-12">
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h5>Lista de Experiências Profissionais   <a  href="{{route('candidato.curriculo.experiencia.novo.get')}}" class="btn-sm btn-secondary" style="float:right;"> <h5>Adicionar Nova Empresa</h5></a> </h5>
                                                    </a>
                                                </div>
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                            ...
                                                            <div class="col-md-12 col-sm-6 col-12">
                                                                <div class="info-box bg-info">
                                                                    ...
                                                                    <div class="info-box-content">
                                                                        ...
                                                                        <span class="info-box-text">{{$experiencia->experiencia->nome_empresa}} - id: {{$experiencia->experiencia->id}}</span>
                                                                        ...
                                                                        <div style="float:right;" class="card-tools">
                                                                            ...
                                                                            <div class="btn-group">
                                                                                ...
                                                                                <div class="dropdown-menu float-right" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
                                                                                    ...
                                                                                    <center>
                                                                                        <a  class="btn badge-info btn-sm"  href="{{route('candidato.curriculo.curso.editar.get', $experiencia->experiencia->id)}}">
                                                                                            <i class="fas fa-edit">
                                                                                                &#160;   Editar &#160;
                                                                                            </i>
...
{{--                                                                                        {{Form::close()}}--}}
                                                                        ...
                                                                        {{--                                                                        </a>--}}
                                                                        {{--                                                                    </td>--}}
                                                                        <span class="info-box-number">Cargo: {{$experiencia->experiencia->cargo}}</span>
                                                                        <span class="info-box-number">Função: {{$experiencia->experiencia->funcao}}</span>
                                                                        <h7></h7>
                                                                        ...
                                                                        Inicio do Trabalho: {{\Carbon\Carbon::parse($experiencia->experiencia->inicio_trabalho)->format('d/m/Y')}}
                                                                            @if($experiencia->experiencia->fim_trabalho == null)
                                                                                Atualmente Trabalhando
                                                                            @else
                                                                                Concluido em {{\Carbon\Carbon::parse($experiencia->experiencia->fim_trabalho)->format('d/m/Y')}}
                                                                            @endif
