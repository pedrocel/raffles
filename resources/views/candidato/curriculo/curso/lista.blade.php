                                        ...
                                        <div class="col-sm-12">
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h5>Lista de cursos   <a  href="{{route('candidato.curriculo.curso.novo.get')}}" class="btn-sm btn-secondary" style="float:right;"> <h5>Adicionar Novo Curso</h5></a> </h5>
                                                    </a>
                                                </div>
                                                <!-- /.card-header -->
                                                <!-- form start -->
                                                        ...
                                                        <div class="col-md-12 col-sm-6 col-12">
                                                            <div class="info-box bg-info">
                                                                ...
                                                                <div class="info-box-content">
                                                                    ...
                                                                    <span class="info-box-text">{{$curso->nome_curso}} - id: {{$curso->id}}</span>
                                                                    ...
                                                                    <div style="float:right;" class="card-tools">
                                                                        ...
                                                                        <div class="btn-group">
                                                                            ...
                                                                            <div class="dropdown-menu float-right" role="menu" x-placement="bottom-start" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(0px, 31px, 0px);">
                                                                                    ...
                                                                                    <center>
                                                                                    <a  class="btn badge-info btn-sm"  href="{{route('candidato.curriculo.curso.editar.get', $curso->id)}}">
                                                                                        <i class="fas fa-edit">
                                                                                            &#160;   Editar &#160;
                                                                                        </i>
...
{{--                                                                        </a>--}}
{{--                                                                    </td>--}}
                                                                    <span class="info-box-number">{{$curso->instituicao}}</span>
                                                                    <h7></h7>
                                                                    ...
                                                                    <span class="progress-description">
                                                                        Inicio do Curso: {{\Carbon\Carbon::parse($curso->inicio_curso)->format('d/m/Y')}}
                                                                        @if($curso->fim_curso == null)
                                                                            Cursando
                                                                            @else
                                                                            Concluido em {{\Carbon\Carbon::parse($curso->fim_curso)->format('d/m/Y')}}
                                                                        @endif
