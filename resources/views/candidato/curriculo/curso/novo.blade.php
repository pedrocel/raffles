                                        ...
                                        <div class="col-sm-12">
                                            <div class="card card-primary">
                                                <div class="card-header">
                                                    <h5 style="font-size: x-large">Novo Curso
                                                ...
                                                <!-- <form role="form"> -->
                                                <div class="card-body">
                                                    {{Form::open(['route' => 'candidato.curriculo.curso.novo.post', 'method' => 'post'])}}
                                                    @if($errors->any())
                                                        <div class="card-body">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-8">
                                                                ...
                                                                <input type="text" id="nome_curso" name="nome_curso"  class="form-control" placeholder="Insira o nome do curso">
                                                            </div>

                                                            <div class="col-8"><br>
                                                                <label for="cep">Instituição</label>
                                                                <input type="text" id="instituicao" name="instituicao"  class="form-control" placeholder="Insira o nome da instituição">
                                                            </div>
