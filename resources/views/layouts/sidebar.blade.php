...
<aside class = "main-sidebar sidebar-dark-primary elevation-4">
    ...
    <img  src   = "/img/logo.png" alt = "Laravel Starter" class = "brand-image img-circle elevation-3"
          style = "opacity: .8">
    <span class = "brand-text font-weight-light">FOCO</span>
</a>
...
{{--                    <ul class = "nav nav-treeview">--}}
{{--                    <li class = "nav-item">--}}
{{--                    <a  href  = "{{route('administrador.rifas.lista.get')}}" class = "nav-link">--}}
...
{{--                        <li class = "nav-item">--}}
{{--                        <a  href  = "{{route('administrador.rifas.novo.get')}}" class = "nav-link">--}}
{{--                        <i  class = "fa fa-circle-o nav-icon"></i>--}}
{{--                              <p>NOVA RIFA</p>--}}
{{--                            </a>--}}
{{--                        </li>--}}
...
{{--                            <p>VAGAS<i class = "fa fa-angle-left right"></i></p>--}}
{{--                    </a>--}}

{{--                    <ul class = "nav nav-treeview">--}}
{{--                        <li class = "nav-item">--}}
{{--                        <a  href="{{route('gestor.vaga.lista.get', Auth::user()->id_organizacao)}}" class = "nav-link">--}}
{{--                        <i  class = "fa fa-circle-o nav-icon"></i>--}}
{{--                    <p>LISTA</p>--}}
{{--                  </a>--}}
{{--                        </li>--}}
